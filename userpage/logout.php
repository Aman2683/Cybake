...
<body>
    ...
    <div class="container-fluid bg-light overflow-hidden px-lg-0" style="margin: 6rem 0;">
        <div class="container quote px-lg-0">
            <div class="col-lg-12 col-md-12 offset-lg-3">
                
                <div class="col-lg-6 quote-text py-5 wow fadeIn" data-wow-delay="0.5s">
                    <div class="p-lg-5 pe-lg-0">
                        <div class="text-center">
							<h1 class="display-5 mb-5">-LOGOUT-</h1>
							
						</div>
                        
                        <form action="Shri Devi Traders/index.php">
                            <div class="row g-3">
                                
								<center><h4>Are You Sure?</h4></center>
                                
                                <div class="col-12">
                                    <button class="btn btn-primary w-100 py-3" type="submit">Logout</button>
                                </div>
                            </div>
                        </form>
                    </div>
