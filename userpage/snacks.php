    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="snacks.php" class="nav-item nav-link active">Snacks and Desserts</a>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="section-title text-center">
                <h1 class="display-5 mb-5">Snacks And Desserts</h1>
            </div>
            ...
            <div class="row g-4 portfolio-container">
			   ...
			   {
				   $cat=$_POST['cat'];
				   $sql1="select * from snacks where type='".$cat."'";
			   }
			   else
			   {
                ...
                <div class="col-lg-4 col-md-6 portfolio-item first wow fadeInUp" data-wow-delay="0.3s">
                    <div class="rounded overflow-hidden">
                        ...
                        <div class="border border-5 border-light border-top-0 p-4">
                            ...
                            <h5 class="lh-base mb-0"><?php echo $type; ?></a>
                            <h5 class="lh-base mb-0"><?php echo $name; ?></a>
							<h5 class="lh-base mb-0" style="color:green;">Price : <?php echo $price; ?>/-</a>
							<h5 class="lh-base mb-0"><?php echo $descr; ?></a>
							<h5 class="lh-base mb-0" style="color:red;">Select Quantity:</a>
							<h5 class="lh-base mb-0"><input type="number" class="form-control" name="qty" value="1" min="1"></a>
							<h5 class="lh-base mb-0" style="color:red;">Delivered Date:</a>
							<h5 class="lh-base mb-0"><input type="date" class="form-control" name="date" required min="<?php echo date('Y-m-d'); ?>" ></a>
							
							<br><br>
							
							<input type="text" name="id1[]" value="<?php echo $id; ?>" hidden="true">
							<button type="submit" name="buy" class="btn btn-outline-warning btn-long cart">Buy Now</button>
...
?>
	...
	if(isset($_POST['buy']))
	{
		foreach ($_POST['id1'] as $key => $value) 
			...
			$qty=$_POST['qty'];
			$date=$_POST['date'];
		$query = "insert into snackorder(pid,qty,date,userid) values('".$id1."','".$qty."','".$date."','".$_SESSION['cakeuser']."')";
		mysqli_query($con,$query) or die(mysqli_error($con));
		echo "<script>
			alert('Your Order Placed. Delivered to your home address');
			</script>";
