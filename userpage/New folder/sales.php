...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="sales.php" class="nav-item nav-link active ">My Sales</a>
            ...
            <!--<a href="<a href="login.php" class="nav-item nav-link" class="btn btn-primary py-4 px-lg-5 d-none d-lg-block">LOGIN<i class="fa fa-sign-in"></i></a>-->
        </div>
    </nav>
    <!-- Navbar End -->
	...
	<div class="text-center">
                <h1 class="display-5 mb-5">My Sales</h1>
				
    </div>
	
	<div class="col-sm-30 col-xl-4" style="margin-left:150px;">
		<div class="bg-light  h-100 p-4">
			<form>
			<div class="row mb-3">
					<label for="UserId" class="col-sm-2 col-form-text">UserId</label>
					<div class="col-sm-4">
					<input type="text" class="form-control border-2" style="height: 40px;">
						
					</div>
			</div>
			<div class="row mb-3">
					<label for="Name" class="col-sm-2 col-form-text">Name</label>
					<div class="col-sm-10">
						<input type="text" class="form-control border-2" style="height: 40px;">
					</div>
			</div>
