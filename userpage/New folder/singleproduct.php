...
<!-- Navbar Start -->
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        <a href="index.php" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
            <h2 class="m-0 text-primary">Shree Devi Traders</h2>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="product.php" class="nav-item nav-link active">Products</a>
					<a href="Req_Product.php" class="nav-item nav-link">Req_Product</a>
				
				<!--<a href="rates.php" class="nav-item nav-link">Rates</a>
                <a href="sales.php" class="nav-item nav-link">My Sales</a>-->
                ...
                <div class="col-lg-4 col-md-4 portfolio-item second wow fadeInUp" data-wow-delay="0.3s">
                    <div class="rounded overflow-hidden">
                        <div class="position-relative overflow-hidden">
                            <img class="img-fluid w-100" src="img/sickle.jpg" alt=""style="height:300px;">
                            <div class="portfolio-overlay">
                                <a class="btn btn-square btn-outline-light mx-1" href="img/sickle.jpg" data-lightbox="portfolio"><i class="fa fa-eye"></i></a>
                ...
                <div class="col-lg-8 about-text py-5 wow fadeIn" data-wow-delay="0.5s">
                    <div class="p-lg-5 pe-lg-0">
					 <div class="border border-5 border-light border-top-0 p-4">
                            ...
                            <h5 class="lh-base mb-0">Farming Sickle</a>
							<p class="mb-4 pb-2">Farming sickle for agriculture purpose</p>
							<h5 class="lh-base mb-0">Available Qty: 50</a>
							<h5 class="lh-base mb-0">Price:100/-</a>
							<div class="row mb-3">
							...
							<div><a href="singleproduct.php"><button>Request</button></a></div>
                        </div>
