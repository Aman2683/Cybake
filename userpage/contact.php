...
{
	include 'config.php';
	$sql = "SELECT name FROM userreg where email='".$_SESSION['cakeuser']."'";
                ...
                <div class="col-lg-6 contact-text py-5 wow fadeIn" data-wow-delay="0.5s">
                    <div class="p-lg-5 ps-lg-0">
                        <div class="section-title text-start">
                            <h1 class="display-5 mb-4">Send Feedback Us</h1>
                        </div>
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="text" name="name" value="<?php echo $_SESSION['uname']; ?>" class="form-control" id="name" placeholder="Your Name" readonly>
                                        <label for="name">Name</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="email" value="<?php echo $_SESSION['cakeuser']; ?>"  name="email" class="form-control" id="email" placeholder="Your Email" readonly>
                                ...
                                <div class="col-12">
                                    <button name="feedback" class="btn btn-primary w-100 py-3"  type="submit">Send Message</button>
                                </div>
                            </div>
                        </form>
						<?php
...
if(isset($_POST['feedback']))
{
	...
	include("config.php");
		...
		$query = "insert into feed(name,email,message) values ('".$_SESSION['uname']."','".$_SESSION['cakeuser']."','".$Message."')";
...
?>
                ...
                <div class="col-lg-6 pe-lg-0" style="min-height: 400px;">
					...
					<img class="img-fluid position-absolute w-100 h-100" src="img/cy02.jpeg" alt="" style="object-fit: cover;" frameborder="0" allowfullscreen="" aria-hidden="false"
                        tabindex="0">
