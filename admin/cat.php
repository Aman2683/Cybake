                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-light rounded h-100 p-4">
							...
							<div class="row mb-3">
                                    <label for="text" class="col-sm-2 col-form-label">Type Category </label>
                                    <div class="col-sm-3">
                                        <input name="cat" type="text" class="form-control" id="shopname" placeholder="Category" required>
                                    </div>
                                </div>
...
?>
					 ...
					 <div class="container-fluid pt-4 px-4">
						<div class="row g-4">
							<div class="col-12">
								<div class="bg-light rounded h-100 p-4">
									<h6 class="mb-4">Added Category</h6>
...
if(isset($_POST['delete']))
{
	...
	$query1 = "delete from cat where id='".$selectid."'";
